...
Current E2E smoke tests are marked with both `e2e` and `slow`. Artifact-heavy index and health tests are marked `integration`.
...
Run integration-marked artifact checks:
