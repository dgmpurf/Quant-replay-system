"""Status view for Tiny PIT reviewed package fixture artifacts."""
...
from quant_replay_system.tiny_pit_reviewed_package_fixture import SAFETY_FALSE_FLAGS
from quant_replay_system.tiny_pit_reviewed_package_fixture_health import check_tiny_pit_reviewed_package_fixture_health
from quant_replay_system.tiny_pit_reviewed_package_fixture_index import (
    NO_TINY_PIT_REVIEWED_PACKAGE_FIXTURE,
...
class TinyPitReviewedPackageFixtureStatusResult:
...
def run_tiny_pit_reviewed_package_fixture_status(
    *,
    root: str | Path = "outputs/reports/manual_diagnostics/tiny_pit_reviewed_package_fixture_v0_1",
    output_dir: str | Path = "outputs/reports/manual_diagnostics/tiny_pit_reviewed_package_fixture_v0_1/status",
) -> TinyPitReviewedPackageFixtureStatusResult:
    sibling_root = Path(output_dir).parent
    index = build_tiny_pit_reviewed_package_fixture_index(root=root, output_dir=sibling_root / "index")
    health = check_tiny_pit_reviewed_package_fixture_health(root=root, output_dir=sibling_root / "health")
    ...
    result = TinyPitReviewedPackageFixtureStatusResult(
        summary_frame=frame,
        artifact_paths=paths,
        warnings=[] if health.status == "PASS" else [f"Tiny PIT reviewed package fixture health is {health.status}."],
        **summary,
    )
    _write(result)
    return result
...
def _summary_from_latest(latest: dict[str, Any], health_status: str) -> dict[str, Any]:
    ...
    summary = {
        "latest_tiny_pit_reviewed_package_fixture_id": _text(latest.get("fixture_id")),
        "latest_tiny_pit_reviewed_package_fixture_status": status,
        "latest_tiny_pit_reviewed_package_fixture_health_status": health_status,
        "latest_tiny_pit_reviewed_package_fixture_workflow_stage": _text(latest.get("workflow_stage")),
        "latest_tiny_pit_reviewed_package_fixture_artifact_path": _text(latest.get("artifact_path")),
        "latest_tiny_pit_reviewed_package_fixture_report_path": _text(latest.get("report_path")),
        "latest_tiny_pit_reviewed_package_fixture_case_count": _to_int(latest.get("case_count")),
        "latest_tiny_pit_reviewed_package_fixture_pass_count": _to_int(latest.get("pass_count")),
        "latest_tiny_pit_reviewed_package_fixture_warn_count": _to_int(latest.get("warn_count")),
        "latest_tiny_pit_reviewed_package_fixture_fail_count": _to_int(latest.get("fail_count")),
        "latest_tiny_pit_reviewed_package_fixture_blocker_count": _to_int(latest.get("blocker_count")),
        "latest_tiny_pit_reviewed_package_fixture_warning_count": _to_int(latest.get("warning_count")),
        "latest_tiny_pit_reviewed_package_fixture_report_only": _to_bool(latest.get("report_only")),
        "latest_tiny_pit_reviewed_package_fixture_diagnostic_only": _to_bool(latest.get("diagnostic_only")),
        "latest_tiny_pit_reviewed_package_fixture_synthetic_only": _to_bool(latest.get("synthetic_only")),
        "latest_tiny_pit_reviewed_package_fixture_real_reviewed_csv_package_created": False,
        "latest_tiny_pit_reviewed_package_fixture_active_reviewed_input_candidate_created": False,
        "latest_tiny_pit_reviewed_package_fixture_real_replay_input_created": False,
        "latest_tiny_pit_reviewed_package_fixture_active_replay_input": False,
        "latest_tiny_pit_reviewed_package_fixture_active_replay_ready": False,
        "latest_tiny_pit_reviewed_package_fixture_active_replay_input_ready_emitted": False,
        "latest_tiny_pit_reviewed_package_fixture_trading_allowed": False,
        "latest_tiny_pit_reviewed_package_fixture_data_raw_written": False,
        "latest_tiny_pit_reviewed_package_fixture_data_processed_written": False,
        "latest_tiny_pit_reviewed_package_fixture_data_cache_written": False,
        "recommended_next_task": VIEWS_NEXT_ACTION if health_status == "PASS" else "Repair Tiny PIT reviewed package fixture artifacts.",
...
def _no_artifact_summary(health_status: str) -> dict[str, Any]:
    return {
        "latest_tiny_pit_reviewed_package_fixture_id": "",
        "latest_tiny_pit_reviewed_package_fixture_status": "NO_PACKAGE_FIXTURE",
        "latest_tiny_pit_reviewed_package_fixture_health_status": health_status,
        "latest_tiny_pit_reviewed_package_fixture_workflow_stage": NO_TINY_PIT_REVIEWED_PACKAGE_FIXTURE,
        "latest_tiny_pit_reviewed_package_fixture_artifact_path": "",
        "latest_tiny_pit_reviewed_package_fixture_report_path": "",
        "latest_tiny_pit_reviewed_package_fixture_case_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_pass_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_warn_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_fail_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_blocker_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_warning_count": 0,
        "latest_tiny_pit_reviewed_package_fixture_report_only": True,
        "latest_tiny_pit_reviewed_package_fixture_diagnostic_only": True,
        "latest_tiny_pit_reviewed_package_fixture_synthetic_only": True,
        "latest_tiny_pit_reviewed_package_fixture_real_reviewed_csv_package_created": False,
        "latest_tiny_pit_reviewed_package_fixture_active_reviewed_input_candidate_created": False,
        "latest_tiny_pit_reviewed_package_fixture_real_replay_input_created": False,
        "latest_tiny_pit_reviewed_package_fixture_active_replay_input": False,
        ...
        "latest_tiny_pit_reviewed_package_fixture_data_processed_written": False,
        "latest_tiny_pit_reviewed_package_fixture_data_cache_written": False,
        "recommended_next_task": "Run tiny-pit-reviewed-package-fixture to create report-only synthetic artifacts.",
        **{flag: False for flag in SAFETY_FALSE_FLAGS},
    }


def _write(result: TinyPitReviewedPackageFixtureStatusResult) -> None:
    ...
    metadata = {
        ...
        "health_status": result.latest_tiny_pit_reviewed_package_fixture_health_status,
        "workflow_stage": result.latest_tiny_pit_reviewed_package_fixture_workflow_stage,
        "latest_fixture_id": result.latest_tiny_pit_reviewed_package_fixture_id,
...
def _paths(output_dir: str | Path) -> dict[str, Path]:
    ...
    return {
        ...
        "status_csv": artifact_dir / "tiny_pit_reviewed_package_fixture_status.csv",
