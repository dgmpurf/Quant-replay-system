...
from quant_replay_system.active_replay_input_emission_status import (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    minimal_replay_input_package_fixture_smoke_index = subparsers.add_parser(
        "minimal-replay-input-package-fixture-smoke-index",
        help="Index minimal replay input package fixture smoke artifacts",
    )
    minimal_replay_input_package_fixture_smoke_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1",
        help="Smoke artifact root to index",
    )
    minimal_replay_input_package_fixture_smoke_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1/index",
        help="Directory where smoke index artifacts will be written",
    )
    minimal_replay_input_package_fixture_smoke_index.set_defaults(
        handler=_handle_minimal_replay_input_package_fixture_smoke_index
    )

    minimal_replay_input_package_fixture_smoke_health = subparsers.add_parser(
        "minimal-replay-input-package-fixture-smoke-health",
        help="Check minimal replay input package fixture smoke artifact health",
    )
    minimal_replay_input_package_fixture_smoke_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1",
        help="Smoke artifact root to check",
    )
    minimal_replay_input_package_fixture_smoke_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1/health",
        help="Directory where smoke health artifacts will be written",
    )
    minimal_replay_input_package_fixture_smoke_health.set_defaults(
        handler=_handle_minimal_replay_input_package_fixture_smoke_health
    )

    minimal_replay_input_package_fixture_smoke_status = subparsers.add_parser(
        "minimal-replay-input-package-fixture-smoke-status",
        help="Summarize latest minimal replay input package fixture smoke status",
    )
    minimal_replay_input_package_fixture_smoke_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1",
        help="Smoke artifact root to summarize",
    )
    minimal_replay_input_package_fixture_smoke_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/minimal_replay_input_package_fixture_smoke_v0_1/status",
        help="Directory where smoke status artifacts will be written",
    )
    ...
    active_replay_input_active_ready = subparsers.add_parser(
        "active-replay-input-active-ready",
        help="Review active replay input active-ready governance as report-only diagnostic context",
    )
    active_replay_input_active_ready.add_argument(
        "--acceptance-artifact",
        default=None,
        help="Optional acceptance artifact folder or acceptance_metadata.json",
    )
    active_replay_input_active_ready.add_argument(
        "--acceptance-health-artifact",
        default=None,
        help="Optional acceptance health artifact JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--acceptance-status-artifact",
        default=None,
        help="Optional acceptance status artifact JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--active-ready-request-manifest",
        default=None,
        help="Optional local active-ready request manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--active-ready-authority-manifest",
        default=None,
        help="Optional local active-ready authority manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--pit-coverage-manifest",
        default=None,
        help="Optional local PIT coverage manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--source-coverage-manifest",
        default=None,
        help="Optional local source coverage manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--evidence-coverage-manifest",
        default=None,
        help="Optional local evidence coverage manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--taxonomy-compliance-manifest",
        default=None,
        help="Optional local taxonomy compliance manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--leakage-review-manifest",
        default=None,
        help="Optional local leakage review manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--side-effect-review-manifest",
        default=None,
        help="Optional local side-effect review manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--overclaim-review-manifest",
        default=None,
        help="Optional local overclaim review manifest JSON",
    )
    active_replay_input_active_ready.add_argument(
        "--output-dir",
    ...
    active_replay_input_final_review = subparsers.add_parser(
        "active-replay-input-final-review",
        help="Review active replay input final-review evidence as report-only diagnostic context",
    )
    active_replay_input_final_review.add_argument(
        "--active-ready-artifact",
        default=None,
        help="Optional active-ready artifact folder or active_ready_metadata.json",
    )
    active_replay_input_final_review.add_argument(
    ...
    active_replay_input_final_review.add_argument(
        ...
        default=None,
        help="Optional local final-review package manifest JSON",
    )
    active_replay_input_final_review.add_argument(
        "--final-review-authority-manifest",
        default=None,
        help="Optional local final-review authority manifest JSON",
    )
    active_replay_input_final_review.add_argument(
        "--final-review-attestation-manifest",
        default=None,
        help="Optional local final-review attestation manifest JSON",
    )
    active_replay_input_final_review.add_argument(
        "--pit-source-evidence-attachment-bundle",
        default=None,
        help="Optional local PIT/source/evidence attachment bundle JSON",
    )
    active_replay_input_final_review.add_argument(
        "--taxonomy-attachment-bundle",
        default=None,
        help="Optional local taxonomy attachment bundle JSON",
    )
    active_replay_input_final_review.add_argument(
    ...
    active_replay_input_final_review.add_argument(
        ...
        default=None,
        help="Optional local emission request manifest JSON",
    )
    active_replay_input_final_review.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1",
        help="Directory where report-only final-review artifacts will be written",
    )
    active_replay_input_final_review.set_defaults(handler=_handle_active_replay_input_final_review)

    active_replay_input_emission = subparsers.add_parser(
        "active-replay-input-emission",
        help="Review active replay input emission preconditions as report-only diagnostic context",
    )
    active_replay_input_emission.add_argument(
        "--final-review-artifact-path",
        default=None,
        help="Optional final-review artifact folder or final_review_metadata.json",
    )
    active_replay_input_emission.add_argument(
        "--final-review-health-artifact-path",
        default=None,
        help="Optional final-review health artifact JSON",
    )
    active_replay_input_emission.add_argument(
        "--final-review-status-artifact-path",
        default=None,
        help="Optional final-review status artifact JSON",
    )
    active_replay_input_emission.add_argument(
    ...
    active_replay_input_emission.add_argument(
        ...
        default=None,
        help="Optional local emission authority manifest JSON",
    )
    active_replay_input_emission.add_argument(
        "--emission-attestation-manifest-path",
        default=None,
        help="Optional local emission attestation manifest JSON",
    )
    active_replay_input_emission.add_argument(
    ...
    active_replay_input_emission.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1",
    ...
    active_replay_input_ready_actual_emission = subparsers.add_parser(
        "active-replay-input-ready-actual-emission",
        help=(
            "Emit report-only ACTIVE_REPLAY_INPUT_READY marker artifacts when all final gates pass "
            "and explicit marker emission is allowed"
        ),
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--emission-decision-artifact-path",
        default=None,
        help="Optional emission-decision artifact folder or active_ready_emission_metadata.json",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--emission-decision-health-artifact-path",
        default=None,
        help="Optional emission-decision health artifact JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--emission-decision-status-artifact-path",
        default=None,
        help="Optional emission-decision status artifact JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--actual-emission-plan-path",
        default=None,
        help="Optional actual marker-only emission plan path",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--actual-emission-request-manifest-path",
        default=None,
        help="Optional local actual marker-only emission request manifest JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--final-authority-manifest-path",
        default=None,
        help="Optional local final marker-only authority manifest JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--second-reviewer-attestation-manifest-path",
        default=None,
        help="Optional local second reviewer marker-only attestation manifest JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--pit-source-evidence-bundle-path",
        default=None,
    ...
    active_replay_input_ready_actual_emission.add_argument(
        ...
        default=None,
        help="Optional local marker candidate manifest JSON",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--allow-active-replay-input-ready-marker-emission",
        action="store_true",
        help="Explicitly allow marker-only ACTIVE_REPLAY_INPUT_READY emission when all gates pass",
    )
    active_replay_input_ready_actual_emission.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1",
        help="Directory where report-only actual marker emission artifacts will be written",
    )
    ...
    real_replay_execute = subparsers.add_parser(
        "real-replay-execute",
        help=(
            "Run report-only real replay execution prechecks and stop at pre-execution "
            "review readiness"
        ),
    )
    real_replay_execute.add_argument(
        "--active-replay-input-artifact-path",
        default=None,
        help="Optional report-only active replay input artifact JSON",
    )
    real_replay_execute.add_argument(
        "--active-input-health-artifact-path",
        default=None,
        help="Optional active replay input health artifact JSON",
    )
    real_replay_execute.add_argument(
        "--active-input-status-artifact-path",
        default=None,
        help="Optional active replay input status artifact JSON",
    )
    real_replay_execute.add_argument(
        "--real-replay-execution-plan-path",
        default=None,
        help="Optional report-only real replay execution precheck plan path",
    )
    real_replay_execute.add_argument(
        "--replay-execution-request-manifest-path",
        default=None,
        help="Optional local real replay execution review request manifest JSON",
    )
    real_replay_execute.add_argument(
        "--replay-execution-authority-manifest-path",
        default=None,
        help="Optional local real replay execution authority manifest JSON",
    )
    real_replay_execute.add_argument(
        "--second-reviewer-attestation-manifest-path",
        default=None,
        help="Optional local second reviewer real replay precheck attestation manifest JSON",
    )
    real_replay_execute.add_argument(
        "--pit-source-evidence-bundle-path",
        default=None,
    ...
    real_replay_execute.add_argument(
        ...
        default=None,
        help="Optional local factor/event/company PIT evidence bundle JSON",
    )
    real_replay_execute.add_argument(
        "--source-hash-revision-available-time-evidence-path",
        default=None,
    ...
    real_replay_execute.add_argument(
        ...
        default=None,
        help="Optional local real replay execution candidate manifest JSON",
    )
    real_replay_execute.add_argument(
        "--output-dir",
    ...
    actual_replay_execute = subparsers.add_parser(
        "actual-replay-execute",
        help="Run report-only actual replay execution core artifacts without replay decisions or labels",
    )
    actual_replay_execute.add_argument("--active-replay-input-artifact-path", default=None)
    actual_replay_execute.add_argument("--active-input-health-artifact-path", default=None)
    actual_replay_execute.add_argument("--active-input-status-artifact-path", default=None)
    actual_replay_execute.add_argument("--real-replay-precheck-artifact-path", default=None)
    actual_replay_execute.add_argument("--real-replay-precheck-health-artifact-path", default=None)
    actual_replay_execute.add_argument("--real-replay-precheck-status-artifact-path", default=None)
    actual_replay_execute.add_argument("--actual-replay-execution-plan-path", default=None)
    actual_replay_execute.add_argument("--approval-manifest-path", default=None)
    actual_replay_execute.add_argument("--actual-replay-execution-request-manifest-path", default=None)
    actual_replay_execute.add_argument("--actual-replay-execution-authority-manifest-path", default=None)
    actual_replay_execute.add_argument("--second-reviewer-attestation-manifest-path", default=None)
    actual_replay_execute.add_argument("--pit-source-evidence-bundle-path", default=None)
    actual_replay_execute.add_argument("--taxonomy-evidence-bundle-path", default=None)
    actual_replay_execute.add_argument("--factor-event-company-evidence-bundle-path", default=None)
    actual_replay_execute.add_argument("--source-hash-revision-available-time-evidence-path", default=None)
    actual_replay_execute.add_argument("--leakage-side-effect-evidence-bundle-path", default=None)
    actual_replay_execute.add_argument("--overclaim-evidence-bundle-path", default=None)
    actual_replay_execute.add_argument("--actual-replay-execution-candidate-manifest-path", default=None)
    actual_replay_execute.add_argument(
        "--allow-actual-replay-execution",
        action="store_true",
        help="Explicitly allow report-only actual replay execution core artifacts when all gates pass",
    )
    actual_replay_execute.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1",
    ...
    metric_evaluation = subparsers.add_parser(
        "metric-evaluation",
        help="Create report-only metric/evaluation phase 1 structural planning diagnostics",
    )
    metric_evaluation.add_argument("--approval-manifest-path", default=None)
    metric_evaluation.add_argument("--metric-evaluation-request-manifest-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-metadata-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-dataset-index-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-sample-rows-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-label-coverage-report-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-split-plan-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-feature-plan-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-label-plan-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-safety-flags-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-status-artifact-path", default=None)
    metric_evaluation.add_argument("--training-evaluation-health-artifact-path", default=None)
    metric_evaluation.add_argument("--metric-definition-request-path", default=None)
    metric_evaluation.add_argument("--sample-scope-request-path", default=None)
    metric_evaluation.add_argument("--denominator-rule-request-path", default=None)
    metric_evaluation.add_argument("--benchmark-industry-request-path", default=None)
    metric_evaluation.add_argument("--leakage-evidence-bundle-path", default=None)
    metric_evaluation.add_argument("--overclaim-evidence-bundle-path", default=None)
    metric_evaluation.add_argument("--side-effect-evidence-bundle-path", default=None)
    metric_evaluation.add_argument(
        "--allow-metric-evaluation-planning-artifacts",
        action="store_true",
        help="Explicitly allow report-only structural metric/evaluation planning artifacts when all gates pass",
    )
    metric_evaluation.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1",
    ...
    training_result = subparsers.add_parser(
        "training-result",
        help="Create report-only actual training_result phase 1 diagnostics",
    )
    training_result.add_argument("--approval-manifest-path", default=None)
    training_result.add_argument("--training-result-request-manifest-path", default=None)
    training_result.add_argument("--training-result-planning-metadata-path", default=None)
    training_result.add_argument("--training-result-planning-input-index-path", default=None)
    training_result.add_argument("--training-result-planning-metric-evidence-index-path", default=None)
    training_result.add_argument("--training-result-planning-lineage-matrix-path", default=None)
    training_result.add_argument("--training-result-planning-limitations-path", default=None)
    training_result.add_argument("--training-result-planning-overfit-warnings-path", default=None)
    training_result.add_argument("--training-result-planning-status-artifact-path", default=None)
    training_result.add_argument("--training-result-planning-health-artifact-path", default=None)
    training_result.add_argument("--metric-extension-metadata-path", default=None)
    training_result.add_argument("--metric-extension-result-rows-path", default=None)
    training_result.add_argument("--metric-extension-summary-path", default=None)
    training_result.add_argument("--metric-extension-safety-flags-path", default=None)
    training_result.add_argument("--metric-extension-status-artifact-path", default=None)
    training_result.add_argument("--metric-extension-health-artifact-path", default=None)
    training_result.add_argument("--metric-computation-metadata-path", default=None)
    training_result.add_argument("--metric-computation-result-rows-path", default=None)
    training_result.add_argument("--metric-computation-summary-path", default=None)
    training_result.add_argument("--metric-computation-safety-flags-path", default=None)
    training_result.add_argument("--metric-computation-status-artifact-path", default=None)
    training_result.add_argument("--metric-computation-health-artifact-path", default=None)
    training_result.add_argument("--metric-evaluation-metadata-path", default=None)
    training_result.add_argument("--metric-evaluation-input-index-path", default=None)
    training_result.add_argument("--metric-evaluation-sample-scope-path", default=None)
    training_result.add_argument("--metric-evaluation-denominator-rules-path", default=None)
    training_result.add_argument("--metric-evaluation-safety-flags-path", default=None)
    training_result.add_argument("--metric-evaluation-status-artifact-path", default=None)
    training_result.add_argument("--metric-evaluation-health-artifact-path", default=None)
    training_result.add_argument("--training-evaluation-metadata-path", default=None)
    training_result.add_argument("--training-evaluation-sample-rows-path", default=None)
    training_result.add_argument("--training-evaluation-safety-flags-path", default=None)
    training_result.add_argument("--training-evaluation-status-artifact-path", default=None)
    training_result.add_argument("--training-evaluation-health-artifact-path", default=None)
    training_result.add_argument("--forward-return-label-metadata-path", default=None)
    training_result.add_argument("--forward-return-label-rows-path", default=None)
    training_result.add_argument("--forward-return-label-status-artifact-path", default=None)
    training_result.add_argument("--forward-return-label-health-artifact-path", default=None)
    training_result.add_argument("--replay-decision-freeze-metadata-path", default=None)
    training_result.add_argument("--replay-decision-freeze-rows-path", default=None)
    training_result.add_argument("--replay-decision-freeze-status-artifact-path", default=None)
    training_result.add_argument("--replay-decision-freeze-health-artifact-path", default=None)
    training_result.add_argument("--leakage-evidence-bundle-path", default=None)
    training_result.add_argument("--overclaim-evidence-bundle-path", default=None)
    training_result.add_argument("--side-effect-evidence-bundle-path", default=None)
    training_result.add_argument(
        "--allow-training-result",
        action="store_true",
        help="Explicitly allow report-only actual training_result artifacts when all gates pass",
    )
    training_result.add_argument(
        "--output-dir",
    ...
    metric_evaluation_index = subparsers.add_parser(
        ...
        help="Index report-only metric/evaluation phase 1 structural planning artifacts",
    )
    metric_evaluation_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1",
        help="Metric/evaluation artifact root to index",
    )
    metric_evaluation_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1/index",
        help="Directory where metric/evaluation index artifacts will be written",
    )
    metric_evaluation_index.set_defaults(handler=_handle_metric_evaluation_index)

    metric_evaluation_health = subparsers.add_parser(
        "metric-evaluation-health",
        help="Health-check report-only metric/evaluation phase 1 structural planning artifacts",
    )
    metric_evaluation_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1",
        help="Metric/evaluation artifact root to health-check",
    )
    metric_evaluation_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1/health",
        help="Directory where metric/evaluation health artifacts will be written",
    )
    metric_evaluation_health.set_defaults(handler=_handle_metric_evaluation_health)

    metric_evaluation_status = subparsers.add_parser(
        "metric-evaluation-status",
        help="Summarize latest report-only metric/evaluation phase 1 artifact status",
    )
    metric_evaluation_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1",
        help="Metric/evaluation artifact root to summarize",
    )
    metric_evaluation_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/metric_evaluation_v0_1/status",
        help="Directory where metric/evaluation status artifacts will be written",
    )
    metric_evaluation_status.set_defaults(handler=_handle_metric_evaluation_status)
    ...
    actual_replay_execute_index = subparsers.add_parser(
        ...
        help="Index report-only actual replay execution artifacts",
    )
    actual_replay_execute_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1",
        help="Actual replay execution artifact root to index",
    )
    actual_replay_execute_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1/index",
        help="Directory where actual replay execution index artifacts will be written",
    )
    actual_replay_execute_index.set_defaults(handler=_handle_actual_replay_execute_index)

    actual_replay_execute_health = subparsers.add_parser(
        "actual-replay-execute-health",
        help="Health-check report-only actual replay execution artifacts",
    )
    actual_replay_execute_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1",
        help="Actual replay execution artifact root to health-check",
    )
    actual_replay_execute_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1/health",
        help="Directory where actual replay execution health artifacts will be written",
    )
    actual_replay_execute_health.set_defaults(handler=_handle_actual_replay_execute_health)

    actual_replay_execute_status = subparsers.add_parser(
        "actual-replay-execute-status",
        help="Summarize report-only actual replay execution artifact status",
    )
    actual_replay_execute_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1",
        help="Actual replay execution artifact root to summarize",
    )
    actual_replay_execute_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/actual_replay_execute_v0_1/status",
        help="Directory where actual replay execution status artifacts will be written",
    )
    actual_replay_execute_status.set_defaults(handler=_handle_actual_replay_execute_status)
    ...
    active_replay_input_ready_actual_emission_index = subparsers.add_parser(
        ...
        help="Index report-only actual ACTIVE_REPLAY_INPUT_READY marker-emission artifacts",
    )
    active_replay_input_ready_actual_emission_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1",
        help="Actual ACTIVE_REPLAY_INPUT_READY marker-emission artifact root to index",
    )
    active_replay_input_ready_actual_emission_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1/index",
        help="Directory where actual-emission index artifacts will be written",
    )
    active_replay_input_ready_actual_emission_index.set_defaults(
        handler=_handle_active_replay_input_ready_actual_emission_index
    )

    active_replay_input_ready_actual_emission_health = subparsers.add_parser(
        "active-replay-input-ready-actual-emission-health",
        help="Health-check report-only actual ACTIVE_REPLAY_INPUT_READY marker-emission artifacts",
    )
    active_replay_input_ready_actual_emission_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1",
        help="Actual ACTIVE_REPLAY_INPUT_READY marker-emission artifact root to health-check",
    )
    active_replay_input_ready_actual_emission_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1/health",
        help="Directory where actual-emission health artifacts will be written",
    )
    active_replay_input_ready_actual_emission_health.set_defaults(
        handler=_handle_active_replay_input_ready_actual_emission_health
    )

    active_replay_input_ready_actual_emission_status = subparsers.add_parser(
        "active-replay-input-ready-actual-emission-status",
        help="Summarize report-only actual ACTIVE_REPLAY_INPUT_READY marker-emission status",
    )
    active_replay_input_ready_actual_emission_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1",
        help="Actual ACTIVE_REPLAY_INPUT_READY marker-emission artifact root to summarize",
    )
    active_replay_input_ready_actual_emission_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_actual_emission_v0_1/status",
        help="Directory where actual-emission status artifacts will be written",
    )
    active_replay_input_ready_actual_emission_status.set_defaults(
        handler=_handle_active_replay_input_ready_actual_emission_status
    )

    active_replay_input_ready_emission_index = subparsers.add_parser(
        "active-replay-input-ready-emission-index",
        help="Index report-only ACTIVE_REPLAY_INPUT_READY emission-decision artifacts",
    )
    active_replay_input_ready_emission_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY emission-decision artifact root to index",
    )
    active_replay_input_ready_emission_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1/index",
        help="Directory where emission-decision index artifacts will be written",
    )
    active_replay_input_ready_emission_index.set_defaults(
        handler=_handle_active_replay_input_ready_emission_index
    )

    active_replay_input_ready_emission_health = subparsers.add_parser(
        "active-replay-input-ready-emission-health",
        help="Check report-only ACTIVE_REPLAY_INPUT_READY emission-decision artifact health",
    )
    active_replay_input_ready_emission_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY emission-decision artifact root to check",
    )
    active_replay_input_ready_emission_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1/health",
        help="Directory where emission-decision health artifacts will be written",
    )
    active_replay_input_ready_emission_health.set_defaults(
        handler=_handle_active_replay_input_ready_emission_health
    )

    active_replay_input_ready_emission_status = subparsers.add_parser(
        "active-replay-input-ready-emission-status",
        help="Summarize latest report-only ACTIVE_REPLAY_INPUT_READY emission-decision status",
    )
    active_replay_input_ready_emission_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY emission-decision artifact root to summarize",
    )
    active_replay_input_ready_emission_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_emission_v0_1/status",
        help="Directory where emission-decision status artifacts will be written",
    )
    active_replay_input_ready_emission_status.set_defaults(
        handler=_handle_active_replay_input_ready_emission_status
    )

    active_replay_input_ready_index = subparsers.add_parser(
        "active-replay-input-ready-index",
        help="Index report-only ACTIVE_REPLAY_INPUT_READY core artifacts",
    )
    active_replay_input_ready_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY artifact root to index",
    )
    active_replay_input_ready_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1/index",
        help="Directory where active-ready index artifacts will be written",
    )
    active_replay_input_ready_index.set_defaults(handler=_handle_active_replay_input_ready_index)

    active_replay_input_ready_health = subparsers.add_parser(
        "active-replay-input-ready-health",
        help="Check report-only ACTIVE_REPLAY_INPUT_READY artifact health",
    )
    active_replay_input_ready_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY artifact root to check",
    )
    active_replay_input_ready_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1/health",
        help="Directory where active-ready health artifacts will be written",
    )
    active_replay_input_ready_health.set_defaults(handler=_handle_active_replay_input_ready_health)

    active_replay_input_ready_status = subparsers.add_parser(
        "active-replay-input-ready-status",
        help="Summarize latest report-only ACTIVE_REPLAY_INPUT_READY status",
    )
    active_replay_input_ready_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1",
        help="ACTIVE_REPLAY_INPUT_READY artifact root to summarize",
    )
    active_replay_input_ready_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_v0_1/status",
        help="Directory where active-ready status artifacts will be written",
    )
    active_replay_input_ready_status.set_defaults(handler=_handle_active_replay_input_ready_status)

    active_replay_input_ready_decision_index = subparsers.add_parser(
        "active-replay-input-ready-decision-index",
        help="Index report-only active replay input ready-decision artifacts",
    )
    active_replay_input_ready_decision_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1",
        help="Ready-decision artifact root to index",
    )
    active_replay_input_ready_decision_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1/index",
        help="Directory where ready-decision index artifacts will be written",
    )
    active_replay_input_ready_decision_index.set_defaults(
        handler=_handle_active_replay_input_ready_decision_index
    )

    active_replay_input_ready_decision_health = subparsers.add_parser(
        "active-replay-input-ready-decision-health",
        help="Check report-only active replay input ready-decision artifact health",
    )
    active_replay_input_ready_decision_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1",
        help="Ready-decision artifact root to check",
    )
    active_replay_input_ready_decision_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1/health",
        help="Directory where ready-decision health artifacts will be written",
    )
    active_replay_input_ready_decision_health.set_defaults(
        handler=_handle_active_replay_input_ready_decision_health
    )

    active_replay_input_ready_decision_status = subparsers.add_parser(
        "active-replay-input-ready-decision-status",
        help="Summarize latest report-only active replay input ready-decision status",
    )
    active_replay_input_ready_decision_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1",
        help="Ready-decision artifact root to summarize",
    )
    active_replay_input_ready_decision_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_ready_decision_v0_1/status",
        help="Directory where ready-decision status artifacts will be written",
    )
    active_replay_input_ready_decision_status.set_defaults(
        handler=_handle_active_replay_input_ready_decision_status
    )

    active_replay_input_emission_index = subparsers.add_parser(
        "active-replay-input-emission-index",
        help="Index report-only active replay input emission artifacts",
    )
    active_replay_input_emission_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1",
        help="Emission artifact root to index",
    )
    active_replay_input_emission_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1/index",
        help="Directory where emission index artifacts will be written",
    )
    active_replay_input_emission_index.set_defaults(handler=_handle_active_replay_input_emission_index)

    active_replay_input_emission_health = subparsers.add_parser(
        "active-replay-input-emission-health",
        help="Check report-only active replay input emission artifact health",
    )
    active_replay_input_emission_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1",
        help="Emission artifact root to check",
    )
    active_replay_input_emission_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1/health",
        help="Directory where emission health artifacts will be written",
    )
    active_replay_input_emission_health.set_defaults(handler=_handle_active_replay_input_emission_health)

    active_replay_input_emission_status = subparsers.add_parser(
        "active-replay-input-emission-status",
        help="Summarize latest report-only active replay input emission status",
    )
    active_replay_input_emission_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1",
        help="Emission artifact root to summarize",
    )
    active_replay_input_emission_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_emission_v0_1/status",
        help="Directory where emission status artifacts will be written",
    )
    active_replay_input_emission_status.set_defaults(handler=_handle_active_replay_input_emission_status)

    active_replay_input_final_review_index = subparsers.add_parser(
        "active-replay-input-final-review-index",
        help="Index report-only active replay input final-review artifacts",
    )
    active_replay_input_final_review_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1",
        help="Final-review artifact root to index",
    )
    active_replay_input_final_review_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1/index",
        help="Directory where final-review index artifacts will be written",
    )
    active_replay_input_final_review_index.set_defaults(handler=_handle_active_replay_input_final_review_index)

    active_replay_input_final_review_health = subparsers.add_parser(
        "active-replay-input-final-review-health",
        help="Check report-only active replay input final-review artifact health",
    )
    active_replay_input_final_review_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1",
        help="Final-review artifact root to check",
    )
    active_replay_input_final_review_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1/health",
        help="Directory where final-review health artifacts will be written",
    )
    active_replay_input_final_review_health.set_defaults(handler=_handle_active_replay_input_final_review_health)

    active_replay_input_final_review_status = subparsers.add_parser(
        "active-replay-input-final-review-status",
        help="Summarize latest report-only active replay input final-review status",
    )
    active_replay_input_final_review_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1",
        help="Final-review artifact root to summarize",
    )
    active_replay_input_final_review_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_final_review_v0_1/status",
        help="Directory where final-review status artifacts will be written",
    )
    active_replay_input_final_review_status.set_defaults(handler=_handle_active_replay_input_final_review_status)
    ...
    active_replay_input_acceptance_index = subparsers.add_parser(
        ...
        help="Index report-only active replay input acceptance artifacts",
    )
    active_replay_input_acceptance_index.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1",
        help="Acceptance artifact root to index",
    )
    active_replay_input_acceptance_index.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1/index",
        help="Directory where acceptance index artifacts will be written",
    )
    active_replay_input_acceptance_index.set_defaults(handler=_handle_active_replay_input_acceptance_index)

    active_replay_input_acceptance_health = subparsers.add_parser(
        "active-replay-input-acceptance-health",
        help="Check report-only active replay input acceptance artifact health",
    )
    active_replay_input_acceptance_health.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1",
        help="Acceptance artifact root to check",
    )
    active_replay_input_acceptance_health.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1/health",
        help="Directory where acceptance health artifacts will be written",
    )
    active_replay_input_acceptance_health.set_defaults(handler=_handle_active_replay_input_acceptance_health)

    active_replay_input_acceptance_status = subparsers.add_parser(
        "active-replay-input-acceptance-status",
        help="Summarize latest report-only active replay input acceptance status",
    )
    active_replay_input_acceptance_status.add_argument(
        "--root",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1",
        help="Acceptance artifact root to summarize",
    )
    active_replay_input_acceptance_status.add_argument(
        "--output-dir",
        default="outputs/reports/manual_diagnostics/active_replay_input_acceptance_v0_1/status",
        help="Directory where acceptance status artifacts will be written",
    )
    active_replay_input_acceptance_status.set_defaults(handler=_handle_active_replay_input_acceptance_status)
    ...
    research_status.add_argument(
        "--active-replay-input-acceptance-root",
...
def _handle_minimal_replay_input_package_fixture_smoke_index(args: argparse.Namespace) -> int:
    result = build_minimal_replay_input_package_fixture_smoke_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    print(
...
def _handle_minimal_replay_input_package_fixture_smoke_health(args: argparse.Namespace) -> int:
    result = check_minimal_replay_input_package_fixture_smoke_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_minimal_replay_input_package_fixture_smoke_status(args: argparse.Namespace) -> int:
    result = run_minimal_replay_input_package_fixture_smoke_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"validator_status: {result.validator_status}")
    print(f"health_status: {result.health_status}")
...
def _handle_active_replay_input_active_ready(args: argparse.Namespace) -> int:
    result = run_active_replay_input_active_ready(
        ActiveReplayInputActiveReadySettings(
            acceptance_artifact=Path(args.acceptance_artifact) if args.acceptance_artifact else None,
            acceptance_health_artifact=Path(args.acceptance_health_artifact)
            if args.acceptance_health_artifact
            else None,
            acceptance_status_artifact=Path(args.acceptance_status_artifact)
            if args.acceptance_status_artifact
            else None,
            active_ready_request_manifest=Path(args.active_ready_request_manifest)
            if args.active_ready_request_manifest
            else None,
            active_ready_authority_manifest=Path(args.active_ready_authority_manifest)
            if args.active_ready_authority_manifest
            else None,
            pit_coverage_manifest=Path(args.pit_coverage_manifest) if args.pit_coverage_manifest else None,
            source_coverage_manifest=Path(args.source_coverage_manifest)
            if args.source_coverage_manifest
            else None,
            evidence_coverage_manifest=Path(args.evidence_coverage_manifest)
            if args.evidence_coverage_manifest
            else None,
            taxonomy_compliance_manifest=Path(args.taxonomy_compliance_manifest)
            if args.taxonomy_compliance_manifest
            else None,
            leakage_review_manifest=Path(args.leakage_review_manifest) if args.leakage_review_manifest else None,
            side_effect_review_manifest=Path(args.side_effect_review_manifest)
            if args.side_effect_review_manifest
            else None,
            overclaim_review_manifest=Path(args.overclaim_review_manifest)
            if args.overclaim_review_manifest
            else None,
            output_dir=Path(args.output_dir),
        )
    )
    ...
    print(f"precondition_count: {result.precondition_count}")
    print(f"blocked_precondition_count: {result.blocked_precondition_count}")
    print(f"authority_gate_count: {result.authority_gate_count}")
    print(f"blocked_authority_gate_count: {result.blocked_authority_gate_count}")
    print(f"lineage_gate_count: {result.lineage_gate_count}")
    print(f"blocked_lineage_gate_count: {result.blocked_lineage_gate_count}")
    print(f"pit_coverage_gate_count: {result.pit_coverage_gate_count}")
    print(f"blocked_pit_coverage_gate_count: {result.blocked_pit_coverage_gate_count}")
    print(f"source_coverage_gate_count: {result.source_coverage_gate_count}")
    print(f"blocked_source_coverage_gate_count: {result.blocked_source_coverage_gate_count}")
    print(f"evidence_coverage_gate_count: {result.evidence_coverage_gate_count}")
    print(f"blocked_evidence_coverage_gate_count: {result.blocked_evidence_coverage_gate_count}")
    print(f"taxonomy_gate_count: {result.taxonomy_gate_count}")
    print(f"blocked_taxonomy_gate_count: {result.blocked_taxonomy_gate_count}")
    print(f"blocker_count: {result.blocker_count}")
    print(f"report_path: {result.artifact_paths['active_ready_report']}")
    print(f"metadata_path: {result.artifact_paths['metadata']}")
    print(
        "No active-ready emission, active replay input, replay, current-candidates, snapshots, "
...
def _handle_active_replay_input_final_review(args: argparse.Namespace) -> int:
    result = run_active_replay_input_final_review(
        ActiveReplayInputFinalReviewSettings(
            active_ready_artifact=Path(args.active_ready_artifact) if args.active_ready_artifact else None,
            active_ready_health_artifact=Path(args.active_ready_health_artifact)
            if args.active_ready_health_artifact
            else None,
            active_ready_status_artifact=Path(args.active_ready_status_artifact)
            if args.active_ready_status_artifact
            else None,
            final_review_package_manifest=Path(args.final_review_package_manifest)
            if args.final_review_package_manifest
            else None,
            final_review_authority_manifest=Path(args.final_review_authority_manifest)
            if args.final_review_authority_manifest
            else None,
            final_review_attestation_manifest=Path(args.final_review_attestation_manifest)
            if args.final_review_attestation_manifest
            else None,
            pit_source_evidence_attachment_bundle=Path(args.pit_source_evidence_attachment_bundle)
            if args.pit_source_evidence_attachment_bundle
            else None,
            taxonomy_attachment_bundle=Path(args.taxonomy_attachment_bundle)
            if args.taxonomy_attachment_bundle
            else None,
            leakage_side_effect_evidence_bundle=Path(args.leakage_side_effect_evidence_bundle)
            if args.leakage_side_effect_evidence_bundle
            else None,
            overclaim_evidence_bundle=Path(args.overclaim_evidence_bundle)
            if args.overclaim_evidence_bundle
            else None,
            emission_request_manifest=Path(args.emission_request_manifest)
            if args.emission_request_manifest
            else None,
            output_dir=Path(args.output_dir),
        )
    )
    print(f"final_review_run_id: {result.final_review_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"ready_for_emission_review: {result.ready_for_emission_review}")
    print(f"active_replay_input_ready: {result.active_replay_input_ready}")
    print(f"active_replay_input: {result.active_replay_input}")
    print(f"active_ready_emitted: {result.active_ready_emitted}")
    print(f"forward_labels_exist: {result.forward_labels_exist}")
    ...
    print(f"active_stock_profile_exists: {result.active_stock_profile_exists}")
    print(f"real_buy_review_eligible: {result.real_buy_review_eligible}")
    print(f"package_gate_count: {result.package_gate_count}")
    print(f"blocked_package_gate_count: {result.blocked_package_gate_count}")
    print(f"lineage_gate_count: {result.lineage_gate_count}")
    print(f"blocked_lineage_gate_count: {result.blocked_lineage_gate_count}")
    print(f"authority_gate_count: {result.authority_gate_count}")
    print(f"blocked_authority_gate_count: {result.blocked_authority_gate_count}")
    print(f"attestation_gate_count: {result.attestation_gate_count}")
    print(f"blocked_attestation_gate_count: {result.blocked_attestation_gate_count}")
    print(f"pit_source_evidence_gate_count: {result.pit_source_evidence_gate_count}")
    print(f"blocked_pit_source_evidence_gate_count: {result.blocked_pit_source_evidence_gate_count}")
    print(f"taxonomy_gate_count: {result.taxonomy_gate_count}")
    print(f"blocked_taxonomy_gate_count: {result.blocked_taxonomy_gate_count}")
    print(f"leakage_side_effect_gate_count: {result.leakage_side_effect_gate_count}")
    print(f"blocked_leakage_side_effect_gate_count: {result.blocked_leakage_side_effect_gate_count}")
    print(f"blocker_count: {result.blocker_count}")
    print(f"report_path: {result.artifact_paths['final_review_report']}")
    print(f"metadata_path: {result.artifact_paths['metadata']}")
    print(
        "No forbidden active-input-ready emission, active replay input, replay, current-candidates, snapshots, "
        "forward labels, training, active stock profiles, real buy-review eligibility, live trading, broker API, "
        "order placement, message delivery, LLM/API, external API, data/raw write, data/processed write, "
        "data/cache write, or cache mutation was invoked."
    )
...
def _handle_active_replay_input_emission(args: argparse.Namespace) -> int:
    result = run_active_replay_input_emission(
        ActiveReplayInputEmissionSettings(
            final_review_artifact_path=Path(args.final_review_artifact_path)
            if args.final_review_artifact_path
            else None,
            final_review_health_artifact_path=Path(args.final_review_health_artifact_path)
            if args.final_review_health_artifact_path
            else None,
            final_review_status_artifact_path=Path(args.final_review_status_artifact_path)
            if args.final_review_status_artifact_path
            else None,
            emission_request_manifest_path=Path(args.emission_request_manifest_path)
            if args.emission_request_manifest_path
            else None,
            emission_authority_manifest_path=Path(args.emission_authority_manifest_path)
            if args.emission_authority_manifest_path
            else None,
            emission_attestation_manifest_path=Path(args.emission_attestation_manifest_path)
            if args.emission_attestation_manifest_path
            else None,
    ...
    print(f"emission_run_id: {result.emission_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"ready_for_active_replay_input_ready_review: {result.ready_for_active_replay_input_ready_review}")
    print(f"active_replay_input_ready: {result.active_replay_input_ready}")
    print(f"active_replay_input: {result.active_replay_input}")
    print(f"active_ready_emitted: {result.active_ready_emitted}")
...
def _handle_active_replay_input_ready_actual_emission(args: argparse.Namespace) -> int:
    result = run_actual_active_replay_input_ready_emission(
        ActualActiveReplayInputReadyEmissionSettings(
            emission_decision_artifact_path=Path(args.emission_decision_artifact_path)
            if args.emission_decision_artifact_path
            else None,
            emission_decision_health_artifact_path=Path(args.emission_decision_health_artifact_path)
            if args.emission_decision_health_artifact_path
            else None,
            emission_decision_status_artifact_path=Path(args.emission_decision_status_artifact_path)
            if args.emission_decision_status_artifact_path
            else None,
            actual_emission_plan_path=Path(args.actual_emission_plan_path)
            if args.actual_emission_plan_path
            else None,
            actual_emission_request_manifest_path=Path(args.actual_emission_request_manifest_path)
            if args.actual_emission_request_manifest_path
            else None,
            final_authority_manifest_path=Path(args.final_authority_manifest_path)
            if args.final_authority_manifest_path
            else None,
            ...
            active_replay_input_ready_marker_candidate_manifest_path=Path(
                args.active_replay_input_ready_marker_candidate_manifest_path
            )
            if args.active_replay_input_ready_marker_candidate_manifest_path
            else None,
            output_dir=Path(args.output_dir),
            allow_active_replay_input_ready_marker_emission=(
                args.allow_active_replay_input_ready_marker_emission
            ),
        )
    )
    print(f"actual_emission_run_id: {result.actual_emission_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"active_replay_input_ready_marker_emitted: {result.active_replay_input_ready_marker_emitted}")
    print(f"active_replay_input_ready: {result.active_replay_input_ready}")
    print(f"active_replay_input: {result.active_replay_input}")
    print(f"active_ready_emitted: {result.active_ready_emitted}")
    print(f"replay_execution_allowed: {result.replay_execution_allowed}")
    ...
    print(f"metadata_path: {result.artifact_paths['metadata']}")
    print(
        "ACTIVE_REPLAY_INPUT_READY, when emitted by this command, is marker-only. No active replay input, "
        "replay, replay decisions, current-candidates, snapshots, forward labels, training, active stock "
...
def _handle_real_replay_execute(args: argparse.Namespace) -> int:
    result = run_real_replay_execute(
        RealReplayExecuteSettings(
            active_replay_input_artifact_path=Path(args.active_replay_input_artifact_path)
            if args.active_replay_input_artifact_path
            else None,
            active_input_health_artifact_path=Path(args.active_input_health_artifact_path)
            if args.active_input_health_artifact_path
            else None,
            active_input_status_artifact_path=Path(args.active_input_status_artifact_path)
            if args.active_input_status_artifact_path
            else None,
            real_replay_execution_plan_path=Path(args.real_replay_execution_plan_path)
            if args.real_replay_execution_plan_path
            else None,
            replay_execution_request_manifest_path=Path(args.replay_execution_request_manifest_path)
            if args.replay_execution_request_manifest_path
            else None,
            replay_execution_authority_manifest_path=Path(args.replay_execution_authority_manifest_path)
            if args.replay_execution_authority_manifest_path
            else None,
            second_reviewer_attestation_manifest_path=Path(args.second_reviewer_attestation_manifest_path)
            if args.second_reviewer_attestation_manifest_path
            else None,
            ...
            replay_execution_candidate_manifest_path=Path(args.replay_execution_candidate_manifest_path)
            if args.replay_execution_candidate_manifest_path
            else None,
            output_dir=Path(args.output_dir),
        )
    )
    print(f"real_replay_execution_run_id: {result.real_replay_execution_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    ...
    print(f"artifact_path: {result.artifact_path}")
    print(
        "Report-only real replay execution precheck does not run replay, create replay decisions, "
        "compute forward labels, train weights, create stock_profile, create buy-review eligibility, "
        "call broker/order/message/API systems, mutate cache, write data/raw, data/processed, or "
        "data/cache, or authorize trading."
    )
...
def _handle_actual_replay_execute(args: argparse.Namespace) -> int:
    result = run_actual_replay_execute(
        ActualReplayExecuteSettings(
            active_replay_input_artifact_path=Path(args.active_replay_input_artifact_path)
            if args.active_replay_input_artifact_path
            else None,
            ...
            real_replay_precheck_artifact_path=Path(args.real_replay_precheck_artifact_path)
            if args.real_replay_precheck_artifact_path
            else None,
            real_replay_precheck_health_artifact_path=Path(args.real_replay_precheck_health_artifact_path)
            if args.real_replay_precheck_health_artifact_path
            else None,
            real_replay_precheck_status_artifact_path=Path(args.real_replay_precheck_status_artifact_path)
            if args.real_replay_precheck_status_artifact_path
            else None,
            actual_replay_execution_plan_path=Path(args.actual_replay_execution_plan_path)
            if args.actual_replay_execution_plan_path
            else None,
            approval_manifest_path=Path(args.approval_manifest_path)
            if args.approval_manifest_path
            else None,
            actual_replay_execution_request_manifest_path=Path(args.actual_replay_execution_request_manifest_path)
            if args.actual_replay_execution_request_manifest_path
            else None,
            actual_replay_execution_authority_manifest_path=Path(args.actual_replay_execution_authority_manifest_path)
            if args.actual_replay_execution_authority_manifest_path
            else None,
            second_reviewer_attestation_manifest_path=Path(args.second_reviewer_attestation_manifest_path)
            if args.second_reviewer_attestation_manifest_path
            else None,
            ...
            actual_replay_execution_candidate_manifest_path=Path(args.actual_replay_execution_candidate_manifest_path)
            if args.actual_replay_execution_candidate_manifest_path
            else None,
            output_dir=Path(args.output_dir),
            allow_actual_replay_execution=args.allow_actual_replay_execution,
        )
    )
    print(f"actual_replay_execution_run_id: {result.actual_replay_execution_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    ...
    print(f"artifact_path: {result.artifact_path}")
    print(
        "Report-only actual replay execution core does not create replay decisions, compute "
...
def _handle_metric_evaluation(args: argparse.Namespace) -> int:
    result = run_metric_evaluation(
        MetricEvaluationSettings(
            approval_manifest_path=Path(args.approval_manifest_path) if args.approval_manifest_path else None,
            metric_evaluation_request_manifest_path=Path(args.metric_evaluation_request_manifest_path)
            if args.metric_evaluation_request_manifest_path
            else None,
            training_evaluation_metadata_path=Path(args.training_evaluation_metadata_path)
            if args.training_evaluation_metadata_path
            else None,
            training_evaluation_dataset_index_path=Path(args.training_evaluation_dataset_index_path)
            if args.training_evaluation_dataset_index_path
            else None,
            ...
            training_evaluation_split_plan_path=Path(args.training_evaluation_split_plan_path)
            if args.training_evaluation_split_plan_path
            else None,
            training_evaluation_feature_plan_path=Path(args.training_evaluation_feature_plan_path)
            if args.training_evaluation_feature_plan_path
            else None,
            training_evaluation_label_plan_path=Path(args.training_evaluation_label_plan_path)
            if args.training_evaluation_label_plan_path
            else None,
            ...
            metric_definition_request_path=Path(args.metric_definition_request_path)
            if args.metric_definition_request_path
            else None,
            sample_scope_request_path=Path(args.sample_scope_request_path) if args.sample_scope_request_path else None,
            denominator_rule_request_path=Path(args.denominator_rule_request_path)
            if args.denominator_rule_request_path
            else None,
            benchmark_industry_request_path=Path(args.benchmark_industry_request_path)
            if args.benchmark_industry_request_path
            else None,
            ...
            output_dir=Path(args.output_dir),
            allow_metric_evaluation_planning_artifacts=args.allow_metric_evaluation_planning_artifacts,
        )
    )
    print(f"metric_evaluation_run_id: {result.metric_evaluation_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"ready_for_metric_evaluation_planning_artifacts: {result.ready_for_metric_evaluation_planning_artifacts}")
    print(f"metric_evaluation_executed: {result.metric_evaluation_executed}")
    print(f"metric_evaluation_planning_artifacts_created: {result.metric_evaluation_planning_artifacts_created}")
    print(f"metric_evaluation_input_index_created: {result.metric_evaluation_input_index_created}")
    ...
    print(f"artifact_path: {result.artifact_path}")
    print(
        "Metric/evaluation phase 1 is report-only structural planning only: not metrics computed, "
...
def _handle_training_result(args: argparse.Namespace) -> int:
    path_fields = {
        field_name: Path(getattr(args, field_name)) if getattr(args, field_name, None) else None
        for field_name in TrainingResultSettings.__dataclass_fields__
        if field_name
        not in {
            "output_dir",
            "allow_training_result",
            "write_artifacts",
            "report_only",
            "diagnostic_only",
        }
    }
    result = run_training_result(
        TrainingResultSettings(
            **path_fields,
            output_dir=Path(args.output_dir),
            allow_training_result=args.allow_training_result,
        )
    )
    print(f"training_result_run_id: {result.training_result_run_id}")
    print(f"status: {result.status}")
    print(f"workflow_stage: {result.workflow_stage}")
...
def _handle_metric_evaluation_index(args: argparse.Namespace) -> int:
    result = build_metric_evaluation_index(root=args.root, output_dir=args.output_dir)
    print(f"Metric/evaluation index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    print(
        "Metric/evaluation phase 1 index is report-only structural planning only. "
        "METRIC_EVALUATION_PLANNING_ARTIFACTS_CREATED is not metrics computed, not result rows, "
...
def _handle_metric_evaluation_health(args: argparse.Namespace) -> int:
    result = check_metric_evaluation_health(root=args.root, output_dir=args.output_dir)
    print(f"Metric/evaluation health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health CSV path: {result.artifact_paths['health_csv']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
    print(f"error_count: {result.error_count}")
    print(f"warning_count: {result.warning_count}")
    print(
        "Metric/evaluation phase 1 health keeps artifacts report-only structural planning only and fails if they imply "
        "computed metrics, result rows, training_result, weights, model_version, thresholds, predictions, "
        "calibrated probabilities, feature importance, stock_profile, buy-review, paper approval, "
        "performance validation, broker/order/message/API/cache/data side effects, snapshots, current-candidates, "
        "signal semantics mutation, or trading."
    )
    return 0


def _handle_metric_evaluation_status(args: argparse.Namespace) -> int:
    result = run_metric_evaluation_status(root=args.root, output_dir=args.output_dir)
    print(f"Metric/evaluation status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status CSV path: {result.artifact_paths['status_csv']}")
...
def _handle_actual_replay_execute_index(args: argparse.Namespace) -> int:
    result = build_actual_replay_execute_index(root=args.root, output_dir=args.output_dir)
    print(f"Actual replay execution index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    print(
        "Report-only actual replay execution index: ACTUAL_REPLAY_EXECUTED means execution artifacts only, "
        "not replay decisions, not labels, not training, not stock_profile, not buy-review, and not trading."
    )
    for warning in result.warnings:
...
def _handle_actual_replay_execute_health(args: argparse.Namespace) -> int:
    result = check_actual_replay_execute_health(root=args.root, output_dir=args.output_dir)
    print(f"Actual replay execution health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health CSV path: {result.artifact_paths['health_csv']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
    print(f"error_count: {result.error_count}")
    print(f"warning_count: {result.warning_count}")
    print(
        "Health enforces report-only semantics: no replay decisions, no forward labels, no training, "
        "no stock_profile, no buy-review eligibility, no broker/order/message/API/cache/data side effects, and no trading."
    )
    return 0


def _handle_actual_replay_execute_status(args: argparse.Namespace) -> int:
    result = run_actual_replay_execute_status(root=args.root, output_dir=args.output_dir)
    print(f"Actual replay execution status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status CSV path: {result.artifact_paths['status_csv']}")
    ...
    print(f"source_real_replay_precheck_run_id: {result.source_real_replay_precheck_run_id}")
    print(f"ready_for_actual_replay_execution: {result.ready_for_actual_replay_execution}")
    print(f"actual_replay_executed: {result.actual_replay_executed}")
    print(f"replay_execution_started: {result.replay_execution_started}")
    print(f"replay_execution_completed: {result.replay_execution_completed}")
...
def _handle_active_replay_input_ready_actual_emission_index(args: argparse.Namespace) -> int:
    result = build_actual_active_replay_input_ready_emission_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
        print(f"WARNING: {warning}")
    print(
        "ACTIVE_REPLAY_INPUT_READY actual emission is marker-only. No active replay input, replay, replay "
        "decisions, current-candidates, snapshots, forward labels, training, active stock profiles, real "
        "buy-review eligibility, research-status integration, checkpoint docs, data writes, API calls, "
        "messages, broker integration, orders, trading, or cache mutation was invoked."
    )
    return 0


def _handle_active_replay_input_ready_actual_emission_health(args: argparse.Namespace) -> int:
    result = check_actual_active_replay_input_ready_emission_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_ready_actual_emission_status(args: argparse.Namespace) -> int:
    result = run_actual_active_replay_input_ready_emission_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(
...
def _handle_active_replay_input_ready_emission_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_ready_emission_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
        print(f"WARNING: {warning}")
    print(
        "No ACTIVE_REPLAY_INPUT_READY emission, active replay input, replay, replay decisions, current-candidates, "
        "snapshots, forward labels, training, active stock profiles, real buy-review eligibility, research-status "
        "integration, data writes, API calls, messages, broker integration, orders, or cache mutation was invoked."
    )
    return 0


def _handle_active_replay_input_ready_emission_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_ready_emission_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_ready_emission_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_ready_emission_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"latest_active_ready_emission_run_id: {result.latest_active_ready_emission_run_id}")
    print(
        "ready_for_active_replay_input_ready_emission_decision: "
        f"{result.ready_for_active_replay_input_ready_emission_decision}"
    )
    ...
    print(
        "No ACTIVE_REPLAY_INPUT_READY emission, active replay input, replay, replay decisions, current-candidates, "
        "snapshots, forward labels, training, active stock profiles, research-status integration, data writes, API "
        "calls, messages, broker integration, orders, or cache mutation was invoked."
    )
    return 1 if result.health_status == "FAIL" else 0


def _handle_active_replay_input_ready_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_ready_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
...
def _handle_active_replay_input_ready_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_ready_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_ready_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_ready_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
...
def _handle_active_replay_input_ready_decision_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_ready_decision_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
    ...
    print(
        "No active input ready emission, active replay input, replay, current-candidates, snapshots, "
        "forward labels, training, active stock profiles, real buy-review eligibility, research-status integration, "
        "data writes, API calls, messages, broker integration, orders, or cache mutation was invoked."
    )
    return 0


def _handle_active_replay_input_ready_decision_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_ready_decision_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_ready_decision_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_ready_decision_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"latest_decision_run_id: {result.latest_decision_run_id}")
    print(
        "ready_for_active_replay_input_ready_decision: "
        f"{result.ready_for_active_replay_input_ready_decision}"
    )
    ...
    print(
        "No active input ready emission, active replay input, replay, current-candidates, snapshots, "
        "forward labels, training, active stock profiles, research-status integration, data writes, API calls, "
        "messages, broker integration, orders, or cache mutation was invoked."
    )
    return 1 if result.health_status == "FAIL" else 0


def _handle_active_replay_input_emission_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_emission_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
...
def _handle_active_replay_input_emission_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_emission_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_emission_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_emission_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"latest_emission_run_id: {result.latest_emission_run_id}")
    print(f"ready_for_active_replay_input_ready_review: {result.ready_for_active_replay_input_ready_review}")
    print(f"active_replay_input_ready: {result.active_replay_input_ready}")
    print(f"active_replay_input: {result.active_replay_input}")
    print(f"active_ready_emitted: {result.active_ready_emitted}")
...
def _handle_active_replay_input_final_review_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_final_review_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index CSV path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    print(
...
def _handle_active_replay_input_final_review_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_final_review_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_final_review_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_final_review_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"latest_final_review_run_id: {result.latest_final_review_run_id}")
    print(f"ready_for_emission_review: {result.ready_for_emission_review}")
    print(f"active_replay_input_ready: {result.active_replay_input_ready}")
    print(f"active_replay_input: {result.active_replay_input}")
    print(f"active_ready_emitted: {result.active_ready_emitted}")
...
def _handle_active_replay_input_acceptance_index(args: argparse.Namespace) -> int:
    result = build_active_replay_input_acceptance_index(root=args.root, output_dir=args.output_dir)
    print(f"Index artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Index path: {result.artifact_paths['index_csv']}")
    print(f"artifact_count: {result.artifact_count}")
    for warning in result.warnings:
...
def _handle_active_replay_input_acceptance_health(args: argparse.Namespace) -> int:
    result = check_active_replay_input_acceptance_health(root=args.root, output_dir=args.output_dir)
    print(f"Health artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Health report path: {result.artifact_paths['health_report']}")
    print(f"status: {result.status}")
    print(f"checked_artifact_count: {result.checked_artifact_count}")
...
def _handle_active_replay_input_acceptance_status(args: argparse.Namespace) -> int:
    result = run_active_replay_input_acceptance_status(root=args.root, output_dir=args.output_dir)
    print(f"Status artifact folder: {result.artifact_paths['artifact_dir']}")
    print(f"Status report path: {result.artifact_paths['status_report']}")
    print(f"latest_acceptance_run_id: {result.latest_acceptance_run_id}")
    print(f"status: {result.status}")
    print(f"health_status: {result.health_status}")
    print(f"workflow_stage: {result.workflow_stage}")
    print(f"ready_for_active_ready_review: {result.ready_for_active_ready_review}")
...
def _handle_research_status(args: argparse.Namespace) -> int:
    ...
    print(
        "active_replay_input_acceptance_implemented: "
        f"{result.active_replay_input_acceptance_implemented}"
    )
    print(
        "active_replay_input_acceptance_views_implemented: "
        f"{result.active_replay_input_acceptance_views_implemented}"
    )
    print(
        "latest_active_replay_input_acceptance_run_id: "
        f"{result.latest_active_replay_input_acceptance_run_id}"
    )
    print(
        "latest_active_replay_input_acceptance_status: "
        f"{result.latest_active_replay_input_acceptance_status}"
    )
    print(
        "latest_active_replay_input_acceptance_health_status: "
        f"{result.latest_active_replay_input_acceptance_health_status}"
    )
    print(
        "latest_active_replay_input_acceptance_workflow_stage: "
        f"{result.latest_active_replay_input_acceptance_workflow_stage}"
    )
    print(f"active_replay_input_acceptance_artifact_path: {result.active_replay_input_acceptance_artifact_path}")
    print(
        "active_replay_input_acceptance_ready_for_active_ready_review: "
        f"{result.active_replay_input_acceptance_ready_for_active_ready_review}"
    )
    print(
        "active_replay_input_acceptance_active_replay_input_ready: "
        f"{result.active_replay_input_acceptance_active_replay_input_ready}"
    )
    print(
        "active_replay_input_acceptance_active_replay_input: "
        f"{result.active_replay_input_acceptance_active_replay_input}"
    )
    print(
        "active_replay_input_acceptance_active_ready_emitted: "
        f"{result.active_replay_input_acceptance_active_ready_emitted}"
    )
    print(
        "active_replay_input_acceptance_forward_labels_exist: "
        f"{result.active_replay_input_acceptance_forward_labels_exist}"
    )
    print(
        "active_replay_input_acceptance_weights_trained: "
        f"{result.active_replay_input_acceptance_weights_trained}"
    )
    print(
        "active_replay_input_acceptance_active_stock_profile_exists: "
        f"{result.active_replay_input_acceptance_active_stock_profile_exists}"
    )
    print(
        "active_replay_input_acceptance_real_buy_review_eligible: "
        f"{result.active_replay_input_acceptance_real_buy_review_eligible}"
    )
    print(f"active_replay_input_acceptance_approval_applied: {result.active_replay_input_acceptance_approval_applied}")
    print(f"active_replay_input_acceptance_order_placed: {result.active_replay_input_acceptance_order_placed}")
    print(f"active_replay_input_acceptance_llm_api_called: {result.active_replay_input_acceptance_llm_api_called}")
    print(
        "active_replay_input_acceptance_external_api_called: "
        f"{result.active_replay_input_acceptance_external_api_called}"
    )
    print(f"active_replay_input_acceptance_cache_mutated: {result.active_replay_input_acceptance_cache_mutated}")
    print(
        "active_replay_input_acceptance_current_candidates_run: "
        f"{result.active_replay_input_acceptance_current_candidates_run}"
    )
    print(f"active_replay_input_acceptance_snapshot_built: {result.active_replay_input_acceptance_snapshot_built}")
    print(
        "active_replay_input_acceptance_signal_semantics_changed: "
        f"{result.active_replay_input_acceptance_signal_semantics_changed}"
    )
    print(f"active_replay_input_acceptance_report_only: {result.active_replay_input_acceptance_report_only}")
    print(f"active_replay_input_acceptance_diagnostic_only: {result.active_replay_input_acceptance_diagnostic_only}")
    print(f"active_replay_input_acceptance_no_live_trading: {result.active_replay_input_acceptance_no_live_trading}")
    print(f"active_replay_input_acceptance_no_broker_api: {result.active_replay_input_acceptance_no_broker_api}")
    print(
        "active_replay_input_acceptance_no_order_placement: "
        f"{result.active_replay_input_acceptance_no_order_placement}"
    )
    ...
    print(
        "active_replay_input_final_review_implemented: "
        f"{result.active_replay_input_final_review_implemented}"
    )
    print(
        "active_replay_input_final_review_views_implemented: "
        f"{result.active_replay_input_final_review_views_implemented}"
    )
    print(
        "latest_active_replay_input_final_review_run_id: "
        f"{result.latest_active_replay_input_final_review_run_id}"
    )
    print(
        "latest_active_replay_input_final_review_status: "
        f"{result.latest_active_replay_input_final_review_status}"
    )
    print(
        "latest_active_replay_input_final_review_health_status: "
        f"{result.latest_active_replay_input_final_review_health_status}"
    )
    print(
        "latest_active_replay_input_final_review_workflow_stage: "
        f"{result.latest_active_replay_input_final_review_workflow_stage}"
    )
    print(f"active_replay_input_final_review_artifact_path: {result.active_replay_input_final_review_artifact_path}")
    print(f"ready_for_emission_review: {result.ready_for_emission_review}")
    print(
        "active_replay_input_final_review_active_replay_input_ready: "
        f"{result.active_replay_input_final_review_active_replay_input_ready}"
    )
    print(
        "active_replay_input_final_review_active_replay_input: "
        f"{result.active_replay_input_final_review_active_replay_input}"
    )
    print(
        "active_replay_input_final_review_active_ready_emitted: "
        f"{result.active_replay_input_final_review_active_ready_emitted}"
    )
    print(
        "active_replay_input_final_review_forward_labels_exist: "
        f"{result.active_replay_input_final_review_forward_labels_exist}"
    )
    print(
        "active_replay_input_final_review_weights_trained: "
        f"{result.active_replay_input_final_review_weights_trained}"
    )
    print(
        "active_replay_input_final_review_active_stock_profile_exists: "
        f"{result.active_replay_input_final_review_active_stock_profile_exists}"
    )
    print(
        "active_replay_input_final_review_real_buy_review_eligible: "
        f"{result.active_replay_input_final_review_real_buy_review_eligible}"
    )
    print(
        "active_replay_input_final_review_approval_applied: "
        f"{result.active_replay_input_final_review_approval_applied}"
    )
    print(
        "active_replay_input_final_review_order_placed: "
        f"{result.active_replay_input_final_review_order_placed}"
    )
    print(
        "active_replay_input_final_review_message_sent: "
        f"{result.active_replay_input_final_review_message_sent}"
    )
    print(
        "active_replay_input_final_review_llm_api_called: "
        f"{result.active_replay_input_final_review_llm_api_called}"
    )
    print(
        "active_replay_input_final_review_external_api_called: "
        f"{result.active_replay_input_final_review_external_api_called}"
    )
    print(
        "active_replay_input_final_review_cache_mutated: "
        f"{result.active_replay_input_final_review_cache_mutated}"
    )
    print(
        "active_replay_input_final_review_data_raw_written: "
        f"{result.active_replay_input_final_review_data_raw_written}"
    )
    print(
        "active_replay_input_final_review_data_processed_written: "
        f"{result.active_replay_input_final_review_data_processed_written}"
    )
    print(
        "active_replay_input_final_review_data_cache_written: "
        f"{result.active_replay_input_final_review_data_cache_written}"
    )
    print(
        "active_replay_input_final_review_current_candidates_run: "
        f"{result.active_replay_input_final_review_current_candidates_run}"
    )
    print(
        "active_replay_input_final_review_snapshot_built: "
        f"{result.active_replay_input_final_review_snapshot_built}"
    )
    print(
        "active_replay_input_final_review_signal_semantics_changed: "
        f"{result.active_replay_input_final_review_signal_semantics_changed}"
    )
    print(f"active_replay_input_final_review_report_only: {result.active_replay_input_final_review_report_only}")
    print(f"active_replay_input_final_review_diagnostic_only: {result.active_replay_input_final_review_diagnostic_only}")
    print(f"active_replay_input_final_review_no_live_trading: {result.active_replay_input_final_review_no_live_trading}")
    print(f"active_replay_input_final_review_no_broker_api: {result.active_replay_input_final_review_no_broker_api}")
    print(
        "active_replay_input_final_review_no_order_placement: "
        f"{result.active_replay_input_final_review_no_order_placement}"
    )
