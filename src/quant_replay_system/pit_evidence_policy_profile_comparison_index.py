        ...
        rows.append(
            {
                ...
                "reviewed_no_hit_support_pass_count": _int(metadata.get("reviewed_no_hit_support_pass_count")),
                "no_hit_context_supported_count": _int(metadata.get("no_hit_context_supported_count")),
